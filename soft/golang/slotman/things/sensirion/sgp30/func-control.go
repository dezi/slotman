...
func (se *SGP30) SetHandler(handler Handler) {
	se.handler = handler
}

func (se *SGP30) ResetSensor() (err error) {
...
func (se *SGP30) GetSensorId() (id byte, err error) {
	id, err = se.i2cDev.ReadRegByte(byte(RegisterId))
	return
}

func (se *SGP30) SetThreshold(threshold float64) {
	se.threshold = threshold
	return
}

func (se *SGP30) GetStatus() (measuring, imUpdate bool, err error) {
...
func (se *SGP30) SetMeasureMode(pressOver, tempOver Oversampling) (err error) {
...
func (se *SGP30) SetIrrFilter(irrFilter IrrFilter) (err error) {
...
func (se *SGP30) SetPowerMode(pm PowerMode, pi PowerInterval) (err error) {
...
func (se *SGP30) ReadTemperature() (celsius float64, err error) {
...
func (se *SGP30) ReadPressure() (hPa float64, err error) {
